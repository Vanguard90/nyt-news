...
class Masthead extends React.Component<{ news: ITopStory[] }, { news: ITopStory[], value: any }> {
	...
	constructor(props: { news: ITopStory[] }) {
		super(props);
		console.log(props);
		this.state = {
			news: [],
	...
	handleChange(event) {
		...
		this.props.news.filter( (singleStory) => {
		...
		return (
			<div className="masthead">
				<div className="textarea">
					...
					<h2>Top stories</h2>
					<input type="text" placeholder="Filter title or text" value={this.state.value} onChange={this.handleChange} />
				</div>
			</div>
		)
	}
